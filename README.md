...
* **Live Score:** Your scores will displayed on the screen
...
## How to Play
1. Open the game in your browser with the link 
2. Allow camera access if you want to play with your actions such as jumping
3. Jump in front of the camer to make the dinosaur jump or simply press the Space button on your keyboard if you dont want to use camera
...
## Hack Club Horizons
I am building this project specifically for the Hack Club Horizons event it is amazing

## 💖 Thank You
* **Hack Club:** A huge thank you to Hack Club for making Horizons and giving chance to make something hardware or even if its software.
* **Open Source Community:** Thanks for the tools that make building and help with camera vision possible for developers.
